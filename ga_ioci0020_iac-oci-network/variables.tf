...
# Passthrough 1:1 del orchestrator
# =========================

# --- Credentials / provider inputs ---
...
# Opcional: solo para evitar warnings si existe en tu var-file.
# NO se pasa al módulo (el orchestrator no lo espera).
...
variable "_meta" {
  description = "Metadata documental del fichero. Ignorado por Terraform."
  type        = any
  default     = null
}